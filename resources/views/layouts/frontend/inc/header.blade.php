                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 text-center text-lg-right">
                        <div id="topline-animation-wrap">
							...
							<a href="mailto:diversify@example.com">info@selfrecovery.com</a>
						</span>
                                <div class="xs-block">
                ...
                <div class="row">
                    <div class="col-sm-12 display_table">
                        <div class="header_left_logo display_table_cell"> <a href="./" class="logo logo_with_text">
                            ...
                            Self Recovery
                            <small class="highlight4">Served 24 Hours to Yuor Door</small>
                        </span>
                            </a> </div>
                        <div class="header_mainmenu display_table_cell text-center">
                            ...
                            <nav class="mainmenu_wrapper">
                                <ul class="mainmenu nav sf-menu">
                                    ...
                                    <li> <a href="{{route('doctorlist')}}">Our Doctors</a>
                                    </li>
